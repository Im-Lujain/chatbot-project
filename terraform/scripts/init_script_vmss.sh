...
sudo -u azureuser git clone -b stage-6.5-tf https:/github.com/Im-Lujain/chatbot-project.git /home/azureuser/chatbot-project

sudo -u azureuser tee /home/azureuser/chatbot-project/.env <<EOF
KEY_VAULT_NAME=<YOUR_KEY_VAULT_NAME>
EOF

sudo -u azureuser /home/azureuser/miniconda3/bin/conda create -n project python=3.11 -y

sudo -u azureuser /home/azureuser/miniconda3/envs/project/bin/pip install -r /home/azureuser/chatbot-project/requirements.txt
